...
You need Python installed, as well as [fluxer.py](https://github.com/akarealemil/fluxer.py) that you can install via pip, `pip install fluxer.py` and run `pip install -r requirements.txt` to get any requirements installed.
